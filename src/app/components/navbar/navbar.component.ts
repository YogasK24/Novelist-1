...
@Component({
  ...
  template: `
    <nav class="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm sticky top-0 z-40 border-b border-slate-200 dark:border-slate-700">
      <div class="container mx-auto px-4">
        <div class="flex justify-between items-center py-3">
          ...
          <button (click)="themeService.toggleTheme()" 
                  class="text-slate-500 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-slate-700 p-2 rounded-full transition-colors"
