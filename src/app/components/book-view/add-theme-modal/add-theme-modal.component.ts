    ...
    >
      ...
      >
        ...
        <form [formGroup]="themeForm" (ngSubmit)="onSubmit()">
          <div class="mb-4">
            <label for="themeName" class="block text-sm font-medium text-slate-600 dark:text-slate-300 mb-1">
              Nama Tema
            </label>
            <input
              type="text"
          ...
          <div class="mb-6">
             <label for="themeDesc" class="block text-sm font-medium text-slate-600 dark:text-slate-300 mb-1">
