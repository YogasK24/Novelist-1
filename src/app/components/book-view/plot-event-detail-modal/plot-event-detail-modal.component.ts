              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    @if (getLocationName(currentEvent.locationId); as locationName) {
                        <div class="flex items-center gap-2 bg-gray-100 dark:bg-gray-700/50 p-3 rounded-md">
                            ...
                            <span class="text-gray-900 dark:text-white font-medium">{{ locationName }}</span>
                        </div>
                    } @else {
                        <p class="text-gray-500 dark:text-gray-400 italic">Tidak ada lokasi spesifik.</p>
                    }
                </div>
                        ...
                        @if (charNames.length > 0) {
                            <div class="space-y-2">
                                @for (name of charNames; track name) {
                                    <div class="flex items-center gap-2 bg-gray-100 dark:bg-gray-700/50 p-2 rounded-md">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-500 dark:text-gray-400" viewBox="0 0 20 20" fill="currentColor">
                             ...
                             <p class="text-gray-500 dark:text-gray-400 italic">Tidak ada karakter yang terlibat.</p>
                        }
                    }
                </div>
              </div>
