    ...
    >
      ...
      >
        ...
        <form [formGroup]="locationForm" (ngSubmit)="onSubmit()">
          <div class="mb-4">
            <label for="locName" class="block text-sm font-medium text-slate-600 dark:text-slate-300 mb-1">
              Nama Lokasi
            </label>
            <input
              type="text"
          ...
          <div class="mb-6">
             <label for="locDesc" class="block text-sm font-medium text-slate-600 dark:text-slate-300 mb-1">
