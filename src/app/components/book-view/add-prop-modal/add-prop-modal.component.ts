    ...
    >
      ...
      >
        ...
        <form [formGroup]="propForm" (ngSubmit)="onSubmit()">
          <div class="mb-4">
            <label for="propName" class="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-1">
              Nama Properti/Item
            </label>
            <input
              type="text"
          ...
          <div class="mb-6">
             <label for="propDesc" class="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-1">
